...
class DetailViewController: UIViewController, AbstractDetailView {
    ...
    private var activityIndicator = UIActivityIndicatorView.autoLayout()
    ...
    private func setupConstraints() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[nameLabel]-8-[ratingLabel]-8-[tableView]|", metrics: nil, views: views))
